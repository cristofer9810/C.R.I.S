...
@section('subtitulo')
    <div class="container">
        <div class="page-header">
            <h1 class="text-4xl all-tittles">Panel para editar los <small>Reportes de comunicacion</small></h1>
        </div>
    </div>
...
@section('grafica')
    ...
    <div class="container-fluid">
        <div class="container-flat-form">
            ...
            {!! Form::model($release, ['route' => ['admin.release.update', $release], 'autocomplete' => 'off', 'files' => true, 'method' => 'put']) !!}

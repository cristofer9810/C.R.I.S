...
@section('subtitulo')
    <div class="container">
        <div class="page-header">
            <h1 class="text-4xl all-tittles">Panel para agregar nuevos <small>Reportes de comunicacion</small></h1>
        </div>
    </div>
...
@section('grafica')
    ...
    <div class="container-fluid">
        <div class="container-flat-form">
            ...
            {!! Form::open(['route' => 'admin.release.store', 'autocomplete' => 'off', 'files' => true]) !!}
            ...
            @include('admin.release.partials.form')

            {!! Form::submit('Guardar Post', ['class' => 'btn btn-primary']) !!}
            </p>
        </div>
    </div>
    {!! Form::close() !!}

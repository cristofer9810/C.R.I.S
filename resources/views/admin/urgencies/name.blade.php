                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%"
                                ...
                                <tr>
                                    <td align="right" valign="top">
                                        <div class="top_pad"
                                            style="height: 25px; line-height: 25px; font-size: 23px;">&nbsp;</div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="left" valign="top">
                                        ...
                                        <a href="#" target="_blank" style="display: block; max-width: 128px;">
                                            <img src="{{ asset('img/Imagen2.png') }}" alt="img" width="150" border="0"
                                ...
                                <tr>
                                    <td align="left" valign="top">
                                        <font face="'Source Sans Pro', sans-serif" color="#1a1a1a"
                                            ...
                                            <span
                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 45px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">muy
                                                buenas soy, {{ $contacto['name'] }}</span>
                                        </font>
                                        ...
                                        <font face="'Source Sans Pro', sans-serif" color="#000000"
                                            ...
                                            <p><strong>Telefono: </strong>{{ $contacto['direccion'] }}</p>
                                            <p><strong>Torre: </strong>{{ $contacto['torre'] }}</p>
                                            <p><strong>Apartamento: </strong>{{ $contacto['apart'] }}</p>
                                            <p><strong>con el estado de deuda: </strong>{{ $contacto['status'] }} con el
                                                siguente mensaje:</p>
                                            ...
                                            <!-- textos -->
                                            <span
                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 24px; line-height: 32px;">{!! $contacto['message'] !!}
                                                <br>
                                                <span
                                                    style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 24px; line-height: 32px;"><b>el
                                                        dia: </b>{{ $contacto['fecha1'] }}
                                                    <br>
                                                    <span
                                                        style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 24px; line-height: 32px;"><b>hasta
                                                            el dia: </b>{{ $contacto['fecha2'] }}
                                        </font>
                                                ...
                                                <tr>
                                                    <td align="center" valign="top">
                                                        ...
                                                        <div style="display: block; max-width: 50px;">
                                                            <img src="{{ asset('img/Imagen3.png') }}" alt="img"
                                                                width="50" border="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="mob_center" align="left" valign="top">
                                                        <div style="height: 13px; line-height: 13px; font-size: 11px;">
                                                            &nbsp;</div>
                                                        <font face="'Source Sans Pro', sans-serif" color="#000000"
                                                            style="font-size: 19px; line-height: 23px; font-weight: 600;">
                                                            <span
                                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 19px; line-height: 23px; font-weight: 600;">C.R.I.S</span>
                                                        </font>
                                                        ...
                                                        <font face="'Source Sans Pro', sans-serif" color="#7f7f7f"
                                                            ...
                                                            <span
                                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #7f7f7f; font-size: 19px; line-height: 23px;">Creative
                                                                Director at C.R.I.S</span>
                                                        </font>
                                                    </td>
                                                    <td width="18"
                                                        style="width: 18px; max-width: 18px; min-width: 18px;">&nbsp;
                                                ...
                                                <tr>
                                                    <td align="center" valign="top">
                                                        ...
                                                        <div style="display: block; max-width: 177px;">
                                                            <img src="{{ asset('img/Imagen1.png') }}" alt="img"
                                                                width="177" border="0"
                                                                style="display: block; width: 177px; max-width: 100%;" />
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                                ...
                                                <td align="center" valign="top">
                                                            ...
                                                            <td align="center" valign="top" width="23%">
                                                                <a href="#" target="_blank"
                                                                    ...
                                                                    <font face="'Source Sans Pro', sans-serif"
                                                                        ...
                                                                        <span
                                                                            style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">HELP&nbsp;CENTER</span>
                                                                    </font>
                                                                </a>
                                                            </td>
                                                            ...
                                                            <td align="center" valign="top" width="23%">
                                                                <a href="#" target="_blank"
                                                                    ...
                                                                    <font face="'Source Sans Pro', sans-serif"
                                                                        ...
                                                                        style="font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">
                                                                        <span
                                                                            style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">SUPPORT&nbsp;24/7</span>
                                                                    </font>
                                                                </a>
                                                            </td>
                                                            <td align="center" valign="top" width="10%">
                                                            ...
                                                            <td align="center" valign="top" width="23%">
                                                                <a href="#" target="_blank"
                                                                    ...
                                                                    <font face="'Source Sans Pro', sans-serif"
                                                                        ...
                                                                        style="font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">
                                                                        <span
                                                                            style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 14px; line-height: 20px; text-decoration: none; white-space: nowrap; font-weight: bold;">ACCOUNT</span>
                                                                    </font>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <font face="'Source Sans Pro', sans-serif" color="#868686"
                                                        ...
                                                        <span
                                                            ...
                                                            &copy; 2020 C.R.I.S All&nbsp;Rights&nbsp;Reserved.
                                                    ...
                                                    <font face="'Source Sans Pro', sans-serif" color="#1a1a1a"
                                                        ...
                                                        <span
                                                            style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px;"><a
                                                                href="#" target="_blank"
                                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">CRIS.service@correo.com</a>
                                                            &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#" target="_blank"
                                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">1(800)232-90-26</a>
                                                            &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#" target="_blank"
                                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">Unsubscribe</a></span>
                                                    </font>
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top">
                                                                <a href="#" target="_blank"
                                                                    ...
                                                                    <img src="{{ asset('img/soc_1.png') }}" alt="img"
                                                                        width="19" border="0"
                                                                        style="display: block; width: 19px;" />
                                                                </a>
                                                            </td>
                                                            <td width="45"
                                                                style="width: 45px; max-width: 45px; min-width: 45px;">
                                                                &nbsp;</td>
                                                            <td align="center" valign="top">
                                                                <a href="#" target="_blank"
                                                                    style="display: block; max-width: 18px;">
                                                                    <img src="{{ asset('img/soc_2.png') }}" alt="img"
                                                                        width="18" border="0"
                                                            ...
                                                            <td align="center" valign="top">
                                                                <a href="#" target="_blank"
                                                                    ...
                                                                    <img src="{{ asset('img/soc_3.png') }}" alt="img"
                                                                        width="21" border="0"
                                                                        style="display: block; width: 21px;" />
                                                                </a>
                                                            </td>
                                                            <td width="45"
                                                                style="width: 45px; max-width: 45px; min-width: 45px;">
                                                            ...
                                                            <td align="center" valign="top">
                                                                <a href="#" target="_blank"
                                                                    ...
                                                                    <img src="{{ asset('img/soc_4.png') }}" alt="img"
                                                                        width="25" border="0"

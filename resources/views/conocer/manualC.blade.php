<x-app-layout>
    ...
    <style>
        .imagen {
            background-image: url("{{ asset('img/manualc.jpg') }}");
            height: 400px;
            width: 100%;
            margin-left: auto;
            margin-right: auto;
    ...
    <div class="py-10 text-center bg-yellow-200 border-t-2 border-black ">
        ...
        <h1 class="py-2">Manual del conjunto residencial</h1>
        <h4 class="font-medium">Informacíon acerca de:<b> Manual del conjunto residencial </b>  

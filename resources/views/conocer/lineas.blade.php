<x-app-layout>
    ...
    <style>
        .imagen {
            background-image: url("{{ asset('img/lineas.jpg') }}");
            height: 400px;
            width: 100%;
            margin-left: auto;
            margin-right: auto;
        ...
        .imagentres{
            background-image: url("{{ asset('img/linea.png') }}");
            margin-left: auto;
            margin-right: auto;
        }
    ...
    <div class="py-10 text-center bg-yellow-200 border-t-2 border-black ">
        ...
        <h1 class="py-2">Lineas de emergencia</h1>
        <h4 class="font-medium">Informacíon acerca de:<b> Lineas de emergencia </b>  
            que le mostrara la Información del conjunto residencial
        </h4>

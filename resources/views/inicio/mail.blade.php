                     ...
                     <tr>
                        <td align="left" valign="top">
                           <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                              ...
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">muy buenas soy,  {{$contacto['name']}}</span>
                           </font>
                           ...
                           <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 24px; line-height: 32px;">
                            ...
                            <p><strong>Con el asunto: </strong>{{$contacto['asunto']}} y mi mensaje es el siguiente:</p>




                              <!-- textos -->
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">{{$contacto['mensaje']}}
                           </font>

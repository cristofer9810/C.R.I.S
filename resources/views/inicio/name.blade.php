                     ...
                     <tr>
                        <td align="left" valign="top">
                           ...
                           <a href="#" target="_blank" style="display: block; max-width: 128px;">
                              <img src="{{ asset('img/Imagen2.png') }}" alt="img" width="150" border="0" style="display: block; width: 200px;" />
                           </a>
                     ...
                     <tr>
                        <td align="left" valign="top">
                           <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">
                              ...
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">muy buenas soy,  {{$reserva['name']}}</span>
                           </font>
                           <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                           <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 24px; line-height: 32px;">
                            <p><strong>Correo: </strong>{{$reserva['correo']}}</p>
                            <p><strong>Telefono: </strong>{{$reserva['telefono']}}</p>
                            <p><strong>Torre: </strong>{{$reserva['torre']}}</p>
                            <p><strong>Apartamento: </strong>{{$reserva['apart']}}</p>
                            <p><strong>Queriendo hacer uso del o la: </strong>{{$reserva['asunto']}} y mi mensaje es el siguiente:</p>




                              <!-- textos -->
                              <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 24px; line-height: 32px;">{{$reserva['mensaje']}}
                                <br>
                            <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 24px; line-height: 32px;"><b>el dia: </b>{{$reserva['date1']}}
                                <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 24px; line-height: 32px;"><b>desde las: </b>{{$reserva['time1']}}
                                    <br>
                                    <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 24px; line-height: 32px;"><b>hasta el dia: </b>{{$reserva['date2']}}
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 24px; line-height: 32px;"><b>hasta las: </b>{{$reserva['time2']}}
                           </font>
                                 ...
                                 <tr>
                                    <td align="center" valign="top">
                                       ...
                                       <div style="display: block; max-width: 50px;">
                                          <img src="{{ asset('img/Imagen3.png') }}" alt="img" width="50" border="0" style="display: block; width: 50px;" />
                                       </div>
                                    </td>
                                 </tr>
                              </table>
                                 ...
                                 <tr>
                                    ...
                                    <td class="mob_center" align="left" valign="top">
                                       ...
                                       <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 19px; line-height: 23px; font-weight: 600;">
                                          <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 19px; line-height: 23px; font-weight: 600;">C.R.I.S</span>
                                       </font>
                                       ...
                                       <font face="'Source Sans Pro', sans-serif" color="#7f7f7f" style="font-size: 19px; line-height: 23px;">
                                          <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #7f7f7f; font-size: 19px; line-height: 23px;">Creative Director at C.R.I.S</span>
                                       </font>
                                    </td>
                                    <td width="18" style="width: 18px; max-width: 18px; min-width: 18px;">&nbsp;</td>
                                 </tr>
                                 ...
                                 <tr>
                                    <td align="center" valign="top">
                                       ...
                                       <div style="display: block; max-width: 177px;">
                                          <img src="{{ asset('img/Imagen1.png') }}" alt="img" width="177" border="0" style="display: block; width: 177px; max-width: 100%;" />
                                       </div>
                                    </td>
                                 </tr>
                              </table>
                                       ...
                                       <tr>
                                          ...
                                          <td align="center" valign="top">
                                             <a href="#" target="_blank" style="display: block; max-width: 25px;">
                                                <img src="{{ asset('img/soc_4.png') }}" alt="img" width="25" border="0" style="display: block; width: 25px;" />
                                             </a>
                                          </td>
                                       </tr>
                                    </table>
